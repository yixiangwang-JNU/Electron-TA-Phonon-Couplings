...
*****************************************************
      ...
      real(8), parameter :: gL=5                 ! coupling strength        
      real(8), parameter :: gT=4                 ! coupling strength    
cc    
      common tem 
      end module value
cc      
...
**********************
	...
	use value
      ...
      real(8) TArray(5),romegaL(5),romegaT(5)
      write(filename1,'(a3,f4.1,a10)') 'gL=',gL,',LA.dat'
      write(filename2,'(a3,f4.1,a10)') 'gT=',gT,',TA.dat' 
